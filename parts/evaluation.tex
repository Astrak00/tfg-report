...
\section{Most efficient language}
...
\begin{table}[ht]
  \centering
  \caption{Power/Energy and execution time for various core counts
    and compiler optimization flags.
    Boldface indicates the minimum value in each row.}
  \label{tab:power-time-bold}
  \begin{tabular}{lrrrrr}
    \toprule
    \textbf{Metric / Flags} & \textbf{-O0}    & \textbf{-O1}
    & \textbf{-O2}    & \textbf{-O3}
    & \textbf{-O3 (fast-math)} \\
    \midrule
