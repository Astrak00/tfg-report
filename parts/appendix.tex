...
\begin{table}[h]
    ...
    \begin{tabular}{lrrrr}
        ...
        \hline
    \end{tabular}
\caption[Server - ram energy consumption]{Energy usage by the ram on the server benchmark by implementation and core count}
...
This section provides the reader with the detailed results of the Raspberry Pi benchmarks, including energy consumption and execution times for the benchmarks ran with different core counts and programming languages.
...
\begin{figure}[h]
    ...
    \end{axis}
    \end{tikzpicture}
    \caption{All languages. Colors = language; labels = platform-cores. \href{https://charts-tfg.astrak.es}{Interactive version: charts-tfg.astrak.es}}
\end{figure}
