...
\begin{figure}
    ...
    \begin{tikzpicture}
  \begin{axis}[
      title={Linear Laptop Execution Time without Python},
      width=\plotwidthgraph,
      height=\plotheightgraph,
      xlabel={Number of Cores},
  ...
  \end{axis}
\end{tikzpicture}
    \caption{Linear Laptop Execution Time}{Execution time of the laptop implementation in different programming languages without Python.}
