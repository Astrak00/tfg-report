\begin{figure}[H]
  ...
  \end{semilogyaxis}
\end{tikzpicture}
\caption[Server - Logarithmic energy (pkg) consumption]{Logarithm energy (pkg) consumption of the Server benchmark across different programming languages. source: \autoref{tab:server-energy-pkg}}
