\begin{figure}[H]
  ...
  \begin{tikzpicture}
  \begin{semilogyaxis}[
      title={Logarithmic Server Package Consumption},
  ...
  \end{semilogyaxis}
\end{tikzpicture}
\caption{Server Package consumption}{Energy consumption of the pkg (package, chips) server in Joules for different core configurations}
