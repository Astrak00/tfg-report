\begin{figure}[H]
  ...
  \end{semilogyaxis}
\end{tikzpicture}
\caption[Server - Logarithmic energy (pkg) consumption]{Logarithm energy (pkg) consumption on the Server across different programming languages. Source: \autoref{tab:server-energy-pkg}}
...
\begin{figure}[H]
  ...
  \end{semilogyaxis}
\end{tikzpicture}
\caption[Server - Logarithmic energy (ram) consumption]{Logarithm energy (ram) consumption on the Server across different programming languages. Source: \autoref{tab:server-energy-ram}}
