...
\begin{figure}[!ht]
  ...
  \begin{tikzpicture}
    \begin{axis}[
        title={Execution Time vs. Core Count for Compiler Optimizations - C++},
        width=\textwidth,   
        height=8cm,         
        ybar,               
        ymode=log,          
...
\begin{figure}[!ht]
  ...
  \begin{tikzpicture}
    \begin{axis}[
        title={Package Energy vs. Core Count for Compiler Optimizations - C++},
        width=\textwidth,
        height=8cm,
        ybar,
        ymode=log,
...
\begin{figure}[!ht]
  ...
  \begin{tikzpicture}
    \begin{axis}[
        title={RAM Energy vs. Core Count for Compiler Optimizations - C++},
        width=\textwidth,
        height=8cm,
        ybar,
        ymode=log,
