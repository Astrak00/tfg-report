\begin{figure}
  ...
  \end{semilogyaxis}
\end{tikzpicture}
    \caption[Desktop - Logarithmic Execution Time]{Logarithm Execution time of the Desktop benchmark across different programming languages. source: \autoref{tab:desktop-execution-time-hyperthreading}}
...
\begin{figure}
  ...
  \end{axis}
\end{tikzpicture}
    \caption[Desktop - Linear execution Time]{Linear execution time of the laptop benchmark across different programming languages without Python. source: \autoref{tab:desktop-execution-time-hyperthreading}}
...
\begin{figure}
  ...
  \end{semilogyaxis}
\end{tikzpicture}
    \caption[Desktop - Logarithmic Execution Time without Hyperthreading]{Logarithm Execution time of the Desktop benchmark without Hyperthreading across different programming languages. source: \autoref{tab:desktop-execution-time}}
