\begin{figure}[h]
    ...
    \begin{tikzpicture}
  \begin{semilogyaxis}[
      title={Energy Consumption - Desktop},
  ...
  \end{semilogyaxis}
\end{tikzpicture}
    \caption[Desktop - Logarithmic energy consumption]{Logarithm energy consumption on the desktop across different programming languages. Source: \autoref{tab:desktop-energy-pkg-hyperthreading}}
...
\begin{figure}
    ...
    \begin{tikzpicture}
  \begin{axis}[
      title={Energy Consumption without Python - Desktop},
      width=\plotwidthgraph,
      height=\plotheightgraph,
      xlabel={Number of Cores},
      ylabel={Energy Consumption (J)},
  ...
  \end{axis}
\end{tikzpicture}
    \caption[Desktop - Linear energy consumption]{Linear energy consumption on the desktop across different programming languages. Source: \autoref{tab:desktop-energy-pkg-hyperthreading}}
...
\begin{figure}
  ...
  \end{semilogyaxis}
\end{tikzpicture}
    \caption[Desktop - Logarithmic package energy consumption without Hyperthreading]{Logarithmic package energy consumption on the desktop without Hyperthreading across different programming languages. Source: \autoref{tab:desktop-energy-pkg}}
