...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \begin{umlsystem}[x=-2,y=-12]{Ray-Tracer Benchmarker}
            ...
            \umlinclude[anchor1=60,anchor2=240,pos=0.6]{runpy}{single}
            \umlinclude[anchor1=70,anchor2=250,pos=0.4]{runpypy}{single}

            % Include relationships to multi-core - staggered positions
            \umlinclude[anchor1=-30,anchor2=180,pos=0.4]{runcpp}{multi}
            \umlinclude[anchor1=330,anchor2=150,pos=0.6]{rungo}{multi}
            \umlinclude[anchor1=300,anchor2=120,pos=0.4]{runpy}{multi}
            \umlinclude[anchor1=270,anchor2=90,pos=0.3]{runpypy}{multi}
