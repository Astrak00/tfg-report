...
The \gls{ARM} (Advanced RISC Machine) is the newest architecture that has reached the global scale. Developed in 1986, the goal of this new 32 bit architecture was the simplicity. As \textcite{arm:story} mentions, the energy efficiency focus came later. This allowed the \gls{ARM} architecture to dominate on the mobile sector, specially in smartphones, which are battery-powered devices.
