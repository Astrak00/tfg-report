...
Currently, this technology is not only used in low-power light devices, but many laptops and even desktops are starting using \gls{ARM} chips due to their power efficiency and performance \cite{arm:optimization-big.LITTLE}. Apple's M1 chip is a great example of this, starting the trend of \gls{ARM} in laptops and desktops.
