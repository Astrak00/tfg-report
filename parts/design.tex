...
As it can be infered from the \autoref{fig:general_program_flow}, the program is divided into two main sections:
\begin{itemize}
...
We can observe in \autoref{fig:raytracer-structures}, there are the different files that compose each of the implementations of the ray-tracer, in C++, Go and Python. The file structure is similar in all three languages, as they must have an almost identical implementations.
