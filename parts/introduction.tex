...
\cite{Shirley2025RTW1}, translating it to go and python, updating the code so that it could handle parallel rendering. 
...
fully understand the project. Theoretical and technological issues are addressed.
  ...
  \item \chapterref{design}, describes the most relevant design decisions with the multi-language renderers and their multi-threaded implementation.
  ...
  \item \chapterref{planification}, describes the organization of the project along the development.
