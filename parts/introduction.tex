...
Energy consumption in the software industry has been rising over the years up to a point that it is now significant at a global scale of energy consumption. % `Insert reference to papers that states how much energy software produces, not in embedded but in laptops, renderer (not washingmachines)`
