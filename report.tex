...
\begin{document}
  ...
  \begin{acknowledgements}
    ...
    Finally, this would not have been possible without the help of my boyfriend, who has been there for me through thick and thin, supporting me in everything during this last year. I am truly grateful for his love and encouragement.
  ...
  Compiled languages with no garbage collection and no managed runtime have usually had the best execution speed as they can reach byte-code for each specific platform, but in the last years, other methods have improved significantly, such as the use of a \gls{jit} compilation.
